...
var shop = function(){
    var shopOptionPrompt = window.prompt(
        "Would you like ot REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter 1 for REFILL, 2 for UPGRADE, or 3 for LEAVE to make a choice."
    );
...
var playerInfo = { //making an object
    name: getPlayerName(),
    health: 100,
    attack: 10,
    money: 10,
    reset: function(){ //creating a method for the object
        this.health = 100;
        this.money = 10;
        this.attack = 10;
    },
